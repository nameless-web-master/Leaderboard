...
/***/ "./src/modules/terminalFx.js":
/*!***********************************!*\
  !*** ./src/modules/terminalFx.js ***!
  \***********************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

      eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\nconst consoleText = (words, id, colors) => {\n  if (colors === undefined) colors = ['#fff'];\n  let visible = true;\n  const con = document.getElementById('console');\n  let letterCount = 1;\n  let x = 1;\n  let waiting = false;\n  const target = document.getElementById(id);\n  target.setAttribute('style', `color:${colors[0]}`);\n  window.setInterval(() => {\n    if (letterCount === 0 && waiting === false) {\n      waiting = true;\n      target.innerHTML = words[0].substring(0, letterCount);\n      window.setTimeout(() => {\n        const usedColor = colors.shift();\n        colors.push(usedColor);\n        const usedWord = words.shift();\n        words.push(usedWord);\n        x = 1;\n        target.setAttribute('style', `color:${colors[0]}`);\n        letterCount += x;\n        waiting = false;\n      }, 1000);\n    } else if (letterCount === words[0].length + 1 && waiting === false) {\n      waiting = true;\n      window.setTimeout(() => {\n        x = -1;\n        letterCount += x;\n        waiting = false;\n      }, 1000);\n    } else if (waiting === false) {\n      target.innerHTML = words[0].substring(0, letterCount);\n      letterCount += x;\n    }\n  }, 120);\n  window.setInterval(() => {\n    if (visible === true) {\n      con.className = 'console-underscore hidden';\n      visible = false;\n    } else {\n      con.className = 'console-underscore';\n\n      visible = true;\n    }\n  }, 400);\n};\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (consoleText);\n\n//# sourceURL=webpack://leaderboard/./src/modules/terminalFx.js?");
...
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {
      ...
      eval("module.exports = __webpack_require__.p + \"1eb9730a7c55f80c98f9.jpg\";\n\n//# sourceURL=webpack://leaderboard/./src/assets/carl-raw-m3hn2Kn5Bns-unsplash.jpg?");
...
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {
      ...
      eval("module.exports = __webpack_require__.p + \"7f504d194d9948e5a435.gif\";\n\n//# sourceURL=webpack://leaderboard/./src/assets/loading.gif?");
...
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {
      ...
      eval("module.exports = __webpack_require__.p + \"17b6a73166cc7adca9a1.woff\";\n\n//# sourceURL=webpack://leaderboard/./src/fonts/Minecrafter.Alt.woff?");
...
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {
      ...
      eval("module.exports = __webpack_require__.p + \"d01657cb4825a5f07246.woff\";\n\n//# sourceURL=webpack://leaderboard/./src/fonts/Minecrafter.Reg.woff?");
